...
Do NOT include any external JavaScript libraries.

Use Unicode emojis or pure HTML/CSS icons instead.

For images, ONLY use Unsplash URLs like:

https://images.unsplash.com/photo-...

Every image must end with:
...
export const generateWebsite=async (req,res) => {
    try {
        ...
        if(user.credits<50){
            return res.status(400).json({message:"You have not enough credits."})
        }
