    ...
    return (
        <div className='min-h-screen bg-[#050505] text-white'>
            ...
            <div className='max-w-7xl mx-auto px-6 py-10'>
                ...
                {websites?.length == 0 && (
                    <div className='mt-12 text-center text-zinc-400'>You have no Websites...</div>
                )}
                        ...
                        {websites.map((w, i) => {
                            ...
                            return <motion.div
                                ...
                                <div className='relative h-40 bg-black cursor-pointer' onClick={() => navigate(`/editor/${w._id}`)}>
                                    <iframe srcDoc={w.latestCode} className='absolute inset-0 w-[140%] h-[140%] scale-[0.72] origin-top-left pointer-events-none bg-white'></iframe>
