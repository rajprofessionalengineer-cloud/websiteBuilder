    ...
    <div className='relative min-h-screen bg-[#040404] text-white overflow-hidden'>
                  ...
                  {openProfile && (
                    <>
                      <motion.div
                        ...
                        className='absolute right-0 mt-3 w-60 z-50 rounded-xl bg-[#0b0b0b] border border-white/10 shadow-2xl overflow-hi'
                      >
      ...
      <section className='pt-44 pb-32 px-6 text-center'>
        ...
        <motion.p
          ...
          Describe your idea and let AI generate a modern ,responsive, prduction-ready website.
        </motion.p>
          ...
          {highlights.map((h, i) => (
            ...
            >
              ...
              <p className='text-sm text-zinc-400'>
                ...
                animations, reponsiveness and scalable structure.
              </p>
            </motion.div>
          ))}
        </div>
